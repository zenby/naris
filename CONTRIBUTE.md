...
После публикации PR он проходит ревью. Участвовать в ревью может каждый желающий, при этом необходимо выполнять следуюющие требования:

- если автор ПР несогласен с замечанием, то указать в ответном комментарии причину несогласия
